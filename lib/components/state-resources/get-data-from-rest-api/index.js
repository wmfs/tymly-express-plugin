      ...
      .then(result => {
        switch (result.statusCode) {
          ...
          default:
            ...
            context.sendTaskFailure({ error: result.statusCode, cause: result.statusMessage })
            break
        }
      })
      .catch(err => context.sendTaskFailure({ error: err.statusCode, cause: err.statusMessage }))
  }
}
